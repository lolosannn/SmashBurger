(function () {
  ...
  var FRIES = [
    ...
    { id: "papas-grandes", name: "Papas grandes", price: 4800 },
    { id: "papas-cheddar-panceta", name: "Papas con cheddar y panceta", price: 6200 }
  ];

  var EXTRAS = [
    { id: "extra-carne", name: "Medallón extra", price: 4500 },
    { id: "extra-cheddar", name: "Cheddar extra", price: 1500 },
    { id: "extra-panceta", name: "Panceta extra", price: 2500 },
    { id: "extra-huevo", name: "Huevo frito", price: 1200 }
  ];
  ...
  sendBtn.addEventListener("click", function () {
    ...
    var lines = [];
    lines.push("🍔 *Nuevo pedido - Smash Burger*");
    lines.push("");
    lines.push("*Pedido:*");
